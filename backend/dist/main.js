...
var app = express__WEBPACK_IMPORTED_MODULE_0___default()(); // instantiate the Express.js  onject
app.use(cors__WEBPACK_IMPORTED_MODULE_1___default()());
app.get("/", _routes_root__WEBPACK_IMPORTED_MODULE_2__.root);
app.get("/api", _routes_api__WEBPACK_IMPORTED_MODULE_3__.api);
app.get(path, _routes_root__WEBPACK_IMPORTED_MODULE_2__.root); // This handler is to handle things that go through this path

...
var crypto = __webpack_require__(/*! crypto */ "crypto");
var packageJson = __webpack_require__(/*! ../package.json */ "./node_modules/.pnpm/dotenv@16.5.0/node_modules/dotenv/package.json");
...
var DEFAULT_MODEL = "Xenova/distilbert-base-cased-distilled-squad";
...
function _getAnswer() {
  _getAnswer = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(userQuestion, userContext) {
    var options, aiModel, response, _ref, answer, score;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0,_xenova_transformers__WEBPACK_IMPORTED_MODULE_0__.pipeline)("question-answering", DEFAULT_MODEL, options);
        case 3:
          aiModel = _context.sent;
          _context.next = 6;
          return aiModel(userQuestion, userContext);
        case 6:
          response = _context.sent;
          _ref = response, answer = _ref.answer, score = _ref.score;
...
app.use((0,express__WEBPACK_IMPORTED_MODULE_0__.json)()); // Allows data to be received from axios through JSON params
...
function handleListen() {
  ...
  console.log("LOG: To debug, start this server in a JavaScript Debug Terminal");
}
})();
